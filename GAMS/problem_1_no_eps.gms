Set i/
$call =xls2gms r=Sheet2!c5:c7 i=test_data.xlsx o=set1.inc
$include set1.inc
/
j /
$call =xls2gms r=Sheet1!d4:e4 s="," i=test_data.xlsx o=set2.inc
$include set2.inc
/;
Alias (i,ip);
...
Parameter
    r(i)/
$call =xls2gms r=Sheet1!h4:i6 i=test_data.xlsx o=par1.inc
$include par1.inc
/
    d(i)/
$call =xls2gms r=Sheet1!k4:l6 i=test_data.xlsx o=par2.inc
$include par2.inc
/
    id(j)/
$call =xls2gms r=Sheet1!b12:c13 i=test_data.xlsx o=par3.inc
$include par3.inc
/;

Table
 p(i,j)
$call =xls2gms r=Sheet1!c4:e7 i=test_data.xlsx o=tab1.inc
$include tab1.inc
;

Table
cost(i, j)
$call =xls2gms r=Sheet1!c11:e14 i=test_data.xlsx o=tab2.inc
$include tab2.inc
;

Table
setup(i,ip)
$call =xls2gms r=Sheet1!h11:k14 i=test_data.xlsx o=tab3.inc
$include tab3.inc
;
Binary Variables
