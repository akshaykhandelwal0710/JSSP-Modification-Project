Set i/
$call =xls2gms r=Sheet8!c5:c24 i=test_data.xlsx o=set1.inc
$include set1.inc
/
j /
$call =xls2gms r=Sheet8!d4:h4 s="," i=test_data.xlsx o=set2.inc
$include set2.inc
/;
Alias (i,ip);
...
Parameter
    r(i)/
$call =xls2gms r=Sheet8!k5:l24 i=test_data.xlsx o=par1.inc
$include par1.inc
/
    d(i)/
$call =xls2gms r=Sheet8!n5:o24 i=test_data.xlsx o=par2.inc
$include par2.inc
/
    id(j)/
$call =xls2gms r=Sheet8!b29:c33 i=test_data.xlsx o=par3.inc
$include par3.inc
/;

Table
 p(i,j)
$call =xls2gms r=Sheet8!c4:h24 i=test_data.xlsx o=tab1.inc
$include tab1.inc
;

Table
cost(i, j)
$call =xls2gms r=Sheet8!c28:h48 i=test_data.xlsx o=tab2.inc
$include tab2.inc
;

Table
setup(i,ip)
$call =xls2gms r=Sheet8!k28:ae48 i=test_data.xlsx o=tab3.inc
$include tab3.inc
;
