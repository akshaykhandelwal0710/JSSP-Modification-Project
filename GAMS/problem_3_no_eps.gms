Set i/
$call =xls2gms r=Sheet3!b5:b11 i=test_data.xlsx o=set1.inc
$include set1.inc
/
j /
$call =xls2gms r=Sheet3!c4:e4 s="," i=test_data.xlsx o=set2.inc
$include set2.inc
/;
Alias (i,ip);
...
Parameter
    r(i)/
$call =xls2gms r=Sheet3!g5:h11 i=test_data.xlsx o=par1.inc
$include par1.inc
/
    d(i)/
$call =xls2gms r=Sheet3!j5:k11 i=test_data.xlsx o=par2.inc
$include par2.inc
/
    id(j)/
$call =xls2gms r=Sheet3!a16:b18 i=test_data.xlsx o=par3.inc
$include par3.inc
/;

Table
 p(i,j)
$call =xls2gms r=Sheet3!b4:e11 i=test_data.xlsx o=tab1.inc
$include tab1.inc
;

Table
cost(i, j)
$call =xls2gms r=Sheet3!b15:e22 i=test_data.xlsx o=tab2.inc
$include tab2.inc
;

Table
setup(i,ip)
$call =xls2gms r=Sheet3!h15:o22 i=test_data.xlsx o=tab3.inc
$include tab3.inc
;
Binary Variables
