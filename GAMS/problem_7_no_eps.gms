Set i/
$call =xls2gms r=Sheet7!c6:c20 i=test_data.xlsx o=set1.inc
$include set1.inc
/
j /
$call =xls2gms r=Sheet7!d5:h5 s="," i=test_data.xlsx o=set2.inc
$include set2.inc
/;
Alias (i,ip);
...
Parameter
    r(i)/
$call =xls2gms r=Sheet7!j6:k20 i=test_data.xlsx o=par1.inc
$include par1.inc
/
    d(i)/
$call =xls2gms r=Sheet7!m6:n20 i=test_data.xlsx o=par2.inc
$include par2.inc
/
    id(j)/
$call =xls2gms r=Sheet7!b24:c28 i=test_data.xlsx o=par3.inc
$include par3.inc
/;

Table
 p(i,j)
$call =xls2gms r=Sheet7!c5:h20 i=test_data.xlsx o=tab1.inc
$include tab1.inc
;

Table
cost(i, j)
$call =xls2gms r=Sheet7!c23:h38 i=test_data.xlsx o=tab2.inc
$include tab2.inc
;

Table
setup(i,ip)
$call =xls2gms r=Sheet7!j23:y38 i=test_data.xlsx o=tab3.inc
$include tab3.inc
;
